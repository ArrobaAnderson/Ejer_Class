class Lista :
    ...
    def obtener(self):
        self.mostrar()
        dato = int(input("Escriba la posición del dato que desea obtener: "))
    ...
    def eliminar(self):
        self.mostrar()
        elimninar_dato = int(input("Escribe la posición del dato a eliminar: "))
...
if res ==None:
    print("Por favor ingrese una posición existente en la lista!")